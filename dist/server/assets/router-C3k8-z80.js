import { X as reactExports, J as isPromise, K as isRedirect, I as isNotFound, E as invariant, h as createControlledPromise, a3 as rootRouteId, L as isServer$1, w as functionalUpdate$1, b as arraysEqual, i as createLRUCache, f as compileDecodeCharMap, a5 as trimPath, a2 as rewriteBasepath, g as composeRewrites, W as processRouteTree, V as processRouteMasks, a1 as resolvePath, d as cleanPath, a7 as trimPathRight, U as parseHref, r as executeRewriteInput, F as isDangerousProtocol, Y as redirect, v as findSingleMatch, m as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, C as interpolatePath, S as nullReplaceEqualDeep, _ as replaceEqualDeep$1, P as last, l as decodePath, t as findFlatMatch, u as findRouteMatch, B as hasKeys, s as executeRewriteOutput, o as encodePathLikeUrl, a6 as trimPathLeft, M as joinPaths, a9 as useRouter, n as dummyMatchContext, Q as matchContext, y as getDefaultExportFromCjs, $ as requireReactDom, q as exactPathTest, Z as removeTrailingSlash, R as React, N as jsxRuntimeExports, H as isModuleNotFoundError, a8 as useHydrated, p as escapeHtml, G as isInlinableStylesheet, x as getAssetCrossOrigin, a0 as resolveManifestAssetLink, O as Outlet } from "./server-Cgfy5VtR.js";
import { s as supabase } from "./client-T0sJvQy8.js";
import { c as createClient } from "./index-ChW4vIqc.js";
import { b as aiChatStream, c as aiNotConfiguredMessage } from "./aiProvider-Cvi-Tcv4.js";
...
const appCss = "/assets/styles-DD93rwsf.css";
...
const useAuthStore = create((set, get) => ({
  ...
  refreshProfile: async () => {
    const user = get().user;
    if (!user) return;
    const { data } = await supabase.from("profiles").select("id,name,email,plan,avatar_url").eq("id", user.id).maybeSingle();
    if (data) {
      set({ profile: data });
    } else {
...
const Route$m = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Stock market analysis, forecasts, and AI insights." },
      { name: "author", content: "StockVision AI" },
      { property: "og:title", content: "StockVision AI — India's AI Investing Platform" },
      { property: "og:description", content: "Stock market analysis, forecasts, and AI insights." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@StockVisionAI" }
    ],
    links: [
      {
        rel: "stylesheet",
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(QueryClientProvider, { client: queryClient, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AuthInit, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { theme: "dark", position: "top-right", richColors: true })
  ] });
}
const $$splitComponentImporter$k = () => import("./login-7pLbwVHK.js");
...
const $$splitComponentImporter$j = () => import("./_authenticated-CyXOGlFT.js");
const Route$k = createFileRoute("/_authenticated")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./index-vmllHJrv.js");
const Route$j = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AI-powered SARIMA + Prophet + LSTM ensemble forecasting for Indian and global markets. Live Yahoo Finance data, portfolio tracking, smart price alerts."
    }, {
      property: "og:title",
      content: "StockVision AI — India's AI Investing Platform"
    }, {
...
const Route$i = createFileRoute("/api/chat")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const messages = Array.isArray(body.messages) ? body.messages.filter((m) => m?.role && m?.content).slice(-20) : [];
        ...
        const system = {
          role: "system",
          content: `You are StockVision AI — expert on Indian equity markets (NSE/BSE), NIFTY, sectors, IPOs, and portfolios.
...
const $$splitComponentImporter$h = () => import("./watchlist-TJgrp6UO.js");
const Route$h = createFileRoute("/_authenticated/watchlist")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./simulator-DUp9sMN-.js");
const Route$g = createFileRoute("/_authenticated/simulator")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./settings-CHbjB91X.js");
const Route$f = createFileRoute("/_authenticated/settings")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./sectors-BOs9sBs-.js");
const Route$e = createFileRoute("/_authenticated/sectors")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./screener-Bmb2ZAfX.js");
const Route$d = createFileRoute("/_authenticated/screener")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./portfolio-p5t4NFrH.js");
const Route$c = createFileRoute("/_authenticated/portfolio")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./news-RKG0gwl5.js");
const Route$b = createFileRoute("/_authenticated/news")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./ipo-futures-C9YWcCvh.js");
const Route$a = createFileRoute("/_authenticated/ipo-futures")({
...
const $$splitComponentImporter$9 = () => import("./ipo-Bvs9ZKle.js");
const Route$9 = createFileRoute("/_authenticated/ipo")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./insights-5JBaUGFj.js");
const Route$8 = createFileRoute("/_authenticated/insights")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./history-XpkSQ-w_.js");
const Route$7 = createFileRoute("/_authenticated/history")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./heatmap-DZ7l87D6.js");
const Route$6 = createFileRoute("/_authenticated/heatmap")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./forecast-Bf0Im0uH.js");
const Route$5 = createFileRoute("/_authenticated/forecast")({
  validateSearch: (s) => ({
    ticker: typeof s.ticker === "string" ? s.ticker : "RELIANCE.NS",
    model: ["SARIMA", "Prophet", "LSTM", "Ensemble"].includes(s.model) ? s.model : "Ensemble"
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./events-DxxMcotE.js");
const Route$4 = createFileRoute("/_authenticated/events")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard-D6FzF48j.js");
const Route$3 = createFileRoute("/_authenticated/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./compare-Ld-BR_Ry.js");
const Route$2 = createFileRoute("/_authenticated/compare")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./chat-D7d1rXT_.js");
const Route$1 = createFileRoute("/_authenticated/chat")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./alerts-CK-a8NB4.js");
const Route2 = createFileRoute("/_authenticated/alerts")({
...
const ApiChatRoute = Route$i.update({
  id: "/api/chat",
  path: "/api/chat",
  getParentRoute: () => Route$m
});
const AuthenticatedWatchlistRoute = Route$h.update({
  id: "/watchlist",
  path: "/watchlist",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedSimulatorRoute = Route$g.update({
  id: "/simulator",
  path: "/simulator",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedSettingsRoute = Route$f.update({
  id: "/settings",
  path: "/settings",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedSectorsRoute = Route$e.update({
  id: "/sectors",
  path: "/sectors",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedScreenerRoute = Route$d.update({
  id: "/screener",
  path: "/screener",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedPortfolioRoute = Route$c.update({
  id: "/portfolio",
  path: "/portfolio",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedNewsRoute = Route$b.update({
  id: "/news",
  path: "/news",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedIpoFuturesRoute = Route$a.update({
  id: "/ipo-futures",
  path: "/ipo-futures",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedIpoRoute = Route$9.update({
  id: "/ipo",
  path: "/ipo",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedInsightsRoute = Route$8.update({
  id: "/insights",
  path: "/insights",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedHistoryRoute = Route$7.update({
  id: "/history",
  path: "/history",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedHeatmapRoute = Route$6.update({
  id: "/heatmap",
  path: "/heatmap",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedForecastRoute = Route$5.update({
  id: "/forecast",
  path: "/forecast",
  getParentRoute: () => AuthenticatedRoute
});
...
const AuthenticatedCompareRoute = Route$2.update({
  id: "/compare",
  path: "/compare",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedChatRoute = Route$1.update({
  id: "/chat",
  path: "/chat",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedAlertsRoute = Route2.update({
  id: "/alerts",
  path: "/alerts",
  getParentRoute: () => AuthenticatedRoute
});
const AuthenticatedRouteChildren = {
  ...
  AuthenticatedForecastRoute,
  AuthenticatedHeatmapRoute,
  AuthenticatedHistoryRoute,
  AuthenticatedInsightsRoute,
  AuthenticatedIpoRoute,
  AuthenticatedIpoFuturesRoute,
  AuthenticatedNewsRoute,
  AuthenticatedPortfolioRoute,
  AuthenticatedScreenerRoute,
  AuthenticatedSectorsRoute,
  AuthenticatedSettingsRoute,
  AuthenticatedSimulatorRoute,
  AuthenticatedWatchlistRoute
};
