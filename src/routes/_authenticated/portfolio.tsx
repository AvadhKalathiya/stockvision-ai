  ...
  return (
    <div className="px-4 py-5 sm:px-6 sm:py-6 lg:px-8 lg:py-8 max-w-7xl mx-auto">
      <header className="mb-6 flex justify-between items-start flex-wrap gap-4">
        <div>
          <h1 className="font-heading text-2xl sm:text-3xl font-bold text-glow-green">Portfolio</h1>
          <p className="text-muted-foreground mt-1 text-sm">Track your holdings and live P&amp;L.</p>
        </div>
        <button
